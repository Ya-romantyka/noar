    ...
    return (
        <>
            <div className={styles.videoWrapper} onClick={openFull}>
                ...
                <Button className={styles.button} variant="outline-white"><PlayIcon/> play</Button>
            </div>
            ...
            {open && (
                <div
                    ...
                    aria-modal="true"
                >
                    <Button className={styles.close} variant="black"
                            onClick={closeFull}><CloseIcon/> close</Button>
                    <video
                        ref={fullRef}
                        controls
                        playsInline
